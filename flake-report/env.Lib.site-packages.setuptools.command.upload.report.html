...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\setuptools\command\upload.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.setuptools.command.upload.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.setuptools.command.upload.source.html#l13">
